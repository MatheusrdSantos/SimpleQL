...
/** @typedef {Object.<string, (createdObject: import('../utils').Element, onEvent: OnEventParam) => Promise<import('../utils').Element>>} onCreation **/
...
/** @typedef {Object.<string, (results: import('../utils').Element[], onEvent: OnEventParam) => Promise<import('../utils').Element[]>>} onResult **/
/** @typedef {(results: import('../utils').Result, onEvent: OnEventParam) => Promise<import('../utils').Element[]>} onSuccess **/
